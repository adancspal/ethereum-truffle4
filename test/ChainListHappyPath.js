...
contract('ChainList', function(accounts) {
	...
	it("should let us sell a first article", function() {
		return ChainList.deployed().then(function(instance) {
			...
			assert.equal(data[5].toNumber(), web3.toWei(articlePrice1, "ether"), "article price should be " + web3.toWei(articlePrice1, "ether"));  
		}); 
	}); 
	...
	it("should let us sell a second article", function() {
		return ChainList.deployed().then(function(instance) {
			...
			assert.equal(data[5].toNumber(), web3.toWei(articlePrice2, "ether"), "article price should be " + web3.toWei(articlePrice2, "ether"));  
		}); 
	});
